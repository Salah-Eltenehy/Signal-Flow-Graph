 ...
 * cycles and returns a list, which contains lists itself with the objects of
 * the
...
public class ElementaryCyclesSearch {
	 ...
	 *                   build sets of the elementary cycles containing the objects
	 *                   of the original
	 *                   graph-representation
	 */
	public ElementaryCyclesSearch(ArrayList<ArrayList<Integer>>[] g) {
		this.adjList = g;
	}
